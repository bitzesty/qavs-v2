...
describe "Citation process" do
  ...
  it 'hides the citation until the group leader confiorms acceptance' do
    ...
    expect(page).to have_content("Do you accept the King's Award for Voluntary Service")
  ...
  it "allows group leader to reject citation", js: true do
    ...
    expect(page).to have_text("If you do not wish to be awarded The King's Award for Voluntary Service, please contact kingsaward@dcms.gov.uk.")
  end
end
