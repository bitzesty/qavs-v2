    ...
    def qavs_step5
      @qavs_step5 ||= proc do
        ...
        options :nomination_local_assessment_form_beneficiaries_based_abroad, "Are the group's beneficiaries based abroad or in other parts of the UK?" do
          ...
          required
          context %(
            <p class="govuk-body>If the answer is ‘no’, please skip to section 5 - ‘Role and status of volunteers’.</p>
            <p class="govuk-body>If the answer is ‘yes’, please answer questions E4.8 and E4.9.</p>
          )
          pdf_context %(
