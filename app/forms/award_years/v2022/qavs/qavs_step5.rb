      ...
      @qavs_step5 ||= proc do
        ...
        textarea :l_citation_summary, "Citation summary" do
          ...
          context %(
            ...
            <p class='govuk-hint'>"Providing advice and practical help to women at risk of domestic abuse."</p>
            <p class='govuk-hint'>"Transforming derelict land into a vibrant community park."</p>
            <p class='govuk-hint'>"Providing a valuable befriending service to local elderly people."</p>
          )
          required
          words_max 15
        end
        ...
        textarea :nomination_local_assessment_form_provided_services, "Please describe the range of services and activities provided by the group" do
          sub_ref "E 3.1"
          context %(
            <p class='govuk-hint'>Please note, if this is a project or branch of a larger organisation, make sure this refers to the work of the project rather than the larger organisation.</p>
          )
        ...
        textarea :nomination_local_assessment_form_affected_by_covid19, "How has the group's operation been affected by the Covid-19 pandemic?" do
          sub_ref "E 3.7"
          context %(
            <p class='govuk-hint'>Please describe in detail if necessary.</p>
          )
          required
        end
        ...
        textarea :nomination_local_assessment_form_offered_services_during_pandemic, "During the pandemic has it been able to offer any additional or different services to the community?" do
          sub_ref "E 3.8"
          context %(
            <p class='govuk-hint'>Please describe in detail.</p>
          )
          required
        end
        ...
        textarea :nomination_local_assessment_form_impact_during_pandemic, "What is the impact of this additional support during Covid-19" do
          sub_ref "E 3.9"
          context %(
            <p class='govuk-hint'>For example, how has it helped, how many people have been supported, creation of beneficial partnerships etc?</p>
          )
          required
        end
        ...
        textarea :nomination_local_assessment_form_volunteer_work_volume, "Please give an idea of the volume of work put in by volunteers" do
          sub_ref "E 4.6"
          context %(
            <p class='govuk-hint'>Ask the group for metrics if possible, for example, 'x' number of volunteering hours are provided by 'y' volunteers each week; or the number of volunteers stated as full time equivalents (FTEs).</p>
          )
          required
        end
        ...
        textarea :nomination_local_assessment_form_volunteer_representation_in_leadership_roles, "How are volunteers represented in key leadership roles? In what ways are volunteers leading, setting direction and acting as an inspiration to the rest of the group?" do
          sub_ref "E 4.8"
          context %(
            <p class='govuk-hint'>We look for groups that are volunteer-led, with volunteers having a key input in decision making at all levels.</p>
          )
          required
        end
        ...
        header :local_assessment_group_organisation_evidence_header, "Evidence of a well-run organisation" do
          ref "E 5"
          context %(
            <p class='govuk-hint'>Before your visit, it is helpful to check how the group is set up (for example, unconstituted group, registered charity, community interest company etc), as the statutory requirements and published information about the group will be different in each case.</p>
            <p class='govuk-hint'>The QAVS guidance for Lieutenancies provides ideas about key things to check and how to do this.</p>
          )
        end
        ...
        textarea :nomination_local_assessment_form_safeguarding_procedures, "Does the group have safeguarding procedures to ensure that children and vulnerable adults are well protected? What are they?" do
          sub_ref "E 5.4"
          context %(
            <p class='govuk-hint'>This may include criminal record checks or having a policy on child protection and insurance indemnity."
          )
          required
        end
        ...
        textarea :nomination_local_assessment_form_adequate_insurance, "Does the group have adequate insurance to cover volunteers and members of the public with whom they interact?" do
          sub_ref "E 5.5"
          context %(
            <p class='govuk-hint'>For example, public liability insurance or employee liability insurance?"
          )
          required
        end
        ...
        textarea :nomination_local_assessment_form_involvement_from_local_bodies, "During your assessment please check to see if any local bodies such as the local authority, police, health, faith or other community organisations have any involvement or support in the activities of the group." do
          sub_ref "E 5.9"
          context %(
            <p class='govuk-hint'>If so please check their views and include your findings below.</p>
          )
          required
        end
        ...
        textarea :nomination_local_assessment_form_volunteer_inclusivity_plans, "Does the group actively plan to encourage a wide range of people to volunteer (ie: from a range of ages, backgrounds, ethnicities and abilities)?" do
          sub_ref "E 6.2"
          context %(
            <p class='govuk-hint'>Examples might include placing leaflets in social centres, libraries, welcoming messages on social media, website, providing training opportunities for unemployed volunteers.</p>
          )
          required
        end
        ...
        textarea :nomination_local_assessment_form_beneficiary_inclusivity_measures, "Does the group reach out to potential beneficiaries that might face barriers to accessing the group's services?" do
          sub_ref "E 6.3"
          context %(
            <p class='govuk-hint'>For example, people with mental health conditions, disabled people, lonely or isolated, older people, unemployed. Please describe the measures used.</p>
          )
          required
        end
        ...
        textarea :nomination_local_assessment_form_services_accessibility, "Does the group take any practical steps to make the group's services accessible?" do
          sub_ref "E 6.4"
          context %(
            <p class='govuk-hint'>For example, physical access to buildings, adjusting opening hours, means of contact and providing materials in a second language or alternative format.</p>
          )
          required
        end
        ...
        text :nomination_local_assessment_form_member_worthy_of_honour, "Does any member of the group stand out as being worthy of an individual honour?" do
          sub_ref "E 7.3"
          context %(
            <p class='govuk-hint'>Please give their name</p>
          )
          required
        end
